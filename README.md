...
adaptor_parse accepts a file folder containing any fastq files held in the main directory of any sub-directory. it parses these files to retrieve their multiplexing adaptors for creating nulk scripts to execute cutadapt for adaptor trimming prior to alignment. 
